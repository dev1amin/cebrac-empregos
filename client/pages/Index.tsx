    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden rounded-b-[25px]">
        <div className="absolute inset-0">
          <img
            src="https://api.builder.io/api/v1/image/assets/TEMP/cd2d1723e38114059b68bdf2a1ae1c4a90270cea?width=2780"
            alt="Hero Background"
        ...
        <nav className="relative z-10 flex items-center justify-between px-10 py-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-white">
                <div className="text-sm font-semibold">cebrac</div>
          ...
          <div className="flex items-center gap-6">
            <a href="#" className="text-white text-sm hover:opacity-80">HOME</a>
            <a href="#" className="text-white text-sm hover:opacity-80">VAGAS</a>
            <a href="#" className="text-white text-sm hover:opacity-80">Mais Informações</a>
            <a href="#" className="text-white text-sm hover:opacity-80">SOBRE</a>
            <a href="#" className="text-white text-sm hover:opacity-80">FAQ</a>
          </div>
        ...
        {/* Hero Content */}
        <div className="relative z-10 px-10 pt-20 pb-32">
          <div className="max-w-2xl">
            <p className="text-white/90 text-sm mb-4">Cebrac Empresa</p>
            ...
            <p className="text-white text-sm mb-8 max-w-md">
              Mais de 5.000 vagas disponíveis e cursos profissionalizantes para impulsionar sua carreira. Junte-se a milhões de profissionais que encontraram sua oportunidade ideal.
            </p>
            <button className="flex items-center gap-3 bg-brand-green text-white px-8 py-3.5 rounded-full font-semibold hover:opacity-90 transition">
