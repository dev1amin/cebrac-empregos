  ...
  return (
    <div className="min-h-screen bg-white" style={{zoom: 0.7, paddingLeft: '100px', paddingRight: '100px'}}>
      ...
      <section className="relative rounded-t-[40px] mx-6 mt-6 overflow-hidden h-[100vh] flex flex-col">
        ...
        <div className="flex h-3 relative z-[999]"  style={{zIndex: '999'}}>
      ...
      <section className="mx-6 mb-20">
        <div className="grid grid-cols-4 gap-6">
          <div className="bg-gray-200 rounded-3xl aspect-video overflow-hidden">
            <img src="image1.mp4" alt="Gallery 1" className="w-full h-full object-cover" />
          </div>
          <div className="bg-gray-200 rounded-3xl aspect-video overflow-hidden">
            <img src="/image2.mp4" alt="Gallery 2" className="w-full h-full object-cover" />
          </div>
          <div className="bg-gray-200 rounded-3xl aspect-video overflow-hidden">
